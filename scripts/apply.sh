#!/usr/bin/env bash
# Apply the patch series to a llama.cpp tree.
#
...
#
# The series is first replayed against a copy of the tree. Only if ALL requested patches
# apply there does the real tree get touched - a half-patched tree can never happen.
set -euo pipefail
...
FILES="common/arg.cpp common/chat.h common/common.h src/llama-kv-cache.cpp
